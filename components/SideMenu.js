...
export default function SideMenu({user, type, img, title, roundImg, cubes = 3200000, selected = false, btnText, onClick, onAreaSelect, onSiteSelect, onPlotSelect, droneSelection, cameraSelection, personSelection, menuSelected, toggleProject }) {
    ...
    return (
        ...
        {pdfOpen &&
        <div className="absolute top-6 right-[4vw] z-30 w-[70vw] h-[87vh]">
    ...
    return (
        ...
        <Image src={'/img/finca-amable.png'} width={125} height={125} className="mb-3 drop-shadow-xl w-auto h-[12vh] aspect-auto"/> 
            ...
            <div className="flex justify-between mt-6 space-x-3">
                        <div className="bg-greenLime p-2 rounded-full cursor-pointer" onClick={cameraSelection}><Image src={'/img/camera-icon.svg'} width={16} height={16} className="mt-[0.08rem] hover:opacity-50"/></div>
                        <div className="bg-greenLime p-2 rounded-full cursor-pointer" onClick={droneSelection}><Image src={'/img/drone-icon.svg'} width={18} height={18} className="mt-0.5 hover:opacity-50"/></div>
                        <div className="bg-greenLime p-2 rounded-full px-3 cursor-pointer" onClick={personSelection}><Image src={'/img/person-icon.svg'} width={8} height={12} className="mx-[0.05rem] hover:opacity-50"/></div>
                    </div>
                <div className={`border-b w-full text-gray-500 mt-4 relative`}> {/* Attach the ref here */}
