...
export default function Header() {
    return (
        ...
        <div className="fixed top-0 left-0 z-10 bg-black/60 text-white flex justify-between items-center w-full py-5 px-10 text-md font-light backdrop-blur">
            <div className="relative pt-5 mr-40"><a href='https://green-cubes-concept.webflow.io/'><Image alt='logo' src='/img/greenCubesLogo.svg' width={161} height={94} className="w-[7vw]"/></a></div>
